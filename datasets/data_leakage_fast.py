...
def match_until_threshold(frames1, frames2, threshold=0.95, match_limit=10, resize_shape=(256, 256), n_jobs=24):
...
# ===== 🛠️ 用户自定义参数 =====
folder_A = "/project/mmendoscope/surgical_video/Cholec80/frames/test/video64"
folder_B = "/project/mmendoscope/surgical_video/M2CAI16-tool/frames/video_13"
threshold = 0.95
match_limit = 10
