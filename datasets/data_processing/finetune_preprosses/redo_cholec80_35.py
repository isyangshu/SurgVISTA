...
path3 = '/project/medimgfmod/syangcw/downstream/cholec80/labels/test/1fpstest_35.pickle'
...
# # 合并data2和data3（data4应为data3）
# merged_data2_3 = {**data2, **data3}
# print(f"Length of merged data2 and data3: {len(merged_data2_3)}")
# print(merged_data2_3.keys())
# count_elements(merged_data2_3, "merged_data2_3")
# output_path = '/project/medimgfmod/syangcw/downstream/cholec80/labels/test/1fpstest_35.pickle'
# with open(output_path, 'wb') as f:
#     pickle.dump(merged_data2_3, f)
