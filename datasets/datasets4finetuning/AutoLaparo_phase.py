...
class PhaseDataset_AutoLaparo(Dataset):
    ...
    def __init__(
        ...
        cut_black=False,
        clip_len=16,
        frame_sample_rate=2,  # 0 indicates exponential intervals, -1 indicates random intervals, and -2 indicates incrementally increasing intervals.
        crop_size=224,
        short_side_size=256,
        new_height=256,
        new_width=340,
