...
class PhaseDataset_CATARACTS(Dataset):
    """Load video phase recognition dataset."""

    def __init__(
        self,
        anno_path="data/CATARACT/labels/train/1fpstrain.pickle",
        data_path="data/CATARACT",
        mode="train",  # val/test
...
def build_dataset(is_train, test_mode, fps, args):
    ...
    print("%s %s - %s : Number of the class = %d" % ("CATARACT", mode, fps, args.nb_classes))
