...
import torch
import models.EndoSSL_utils.lr_decay as lrd
from timm.models import create_model
import models.EndoSSL_utils.models_vit as models_vit
from models.EndoSSL_utils.pos_embed import interpolate_pos_embed
"""
...
def prepare_mae_model(model_type, nb_classes, drop_path, ckpt, return_optimizer_groups=False, weight_decay=0., layer_decay=1.0, verbose=True, debug=False):
    # build model
    print("Configuring EndoSSL model:")
    ...
    if ckpt:
        ...
        print("Loaded pre-trained EndoSSL checkpoint from: %s" % ckpt)
