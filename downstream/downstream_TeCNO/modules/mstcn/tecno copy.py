...
class TeCNO(LightningModule):
    ...
    def calc_precision_and_recall(self, y_pred, y_true, step="val"):
        y_pred = y_pred[-1].squeeze().transpose(1, 0)
        y_true = y_true.squeeze()
        # y_max_pred, y_true, _ = _input_format_classification(y_pred, y_true, threshold=0.5, is_multiclass=True)
    ...
    # def _input_format_classification(self, y_pred, y_true, threshold=0.5):
    #     """
