...
from utils_tecno.utils import (
    argparse_summary,
    get_class_by_path,
)
from utils_tecno.configargparse_arguments import build_configargparser
...
if __name__ == "__main__":
    ...
    if hparams.data_root is not None:
        hparams.name = date_str + exp_name + hparams.data_root.split("/")[-2]
    else:
