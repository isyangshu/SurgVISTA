...
def merge(eval_path, num_tasks):
    ...
    for x in range(num_tasks):
        ...
        for line in lines:
            ...
            data = softmax(data)
            if not video_name in dict_feats:
                dict_feats[video_name] = []
                dict_label[video_name] = 0
            dict_feats[video_name].append(data)
            dict_label[video_name] = label
    ...
    return final_top1 * 100, final_top5 * 100, accuracy * 100, precision * 100, recall * 100, mAP * 100
