...
from downstream.utils import NativeScalerWithGradNormCount as NativeScaler
from downstream.utils import multiple_samples_collate
import downstream.utils as utils

from downstream.model.unifiedmodel import unified_base, unified_base_2D, unified_base_st
from downstream.model.unifiedmodel_image import unified_base_image
...
def get_args():
    ...
    parser.add_argument(
        "--data_set",
        default="CholecT50",
        choices=["CholecT50", "CholecT50C", "Prostate21"],
        type=str,
        help="dataset",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--qkv_bias", action="store_false", default=True, help="Perform evaluation only"
    )
    parser.add_argument(
        "--qkv_divided_bias", action="store_true", default=False, help="Perform evaluation only"
    )
    parser.add_argument(
        "--qkv_divided", action="store_true", default=False, help="Perform evaluation only"
    )
    parser.add_argument(
        "--dist_eval",
        action="store_true",
...
def main(args, ds_init):
    ...
    args.output_dir = os.path.join(
        ...
        "_".join(
            [
                args.model,
                args.pretrained_data,
                args.pretrained_method,
                args.data_set,
                str(args.lr),
    ...
    if args.pretrained_data == "k400":
        if "base" in args.model and args.pretrained_method == 'timesformer':
            pretrained_path = "/home/syangcw/SurgSSL/pretrain_params/timesformer_base_patch16_224_K400.pyth"
            args.qkv_bias = False
        ...
        if "base" in args.model and args.pretrained_method == 'mvd':
            ...
            args.qkv_divided_bias = True
            args.qkv_divided = False
        # elif "large" in args.model and args.pretrained_method == 'videomae':
        #     pretrained_path = "/home/syangcw/SurgSSL/pretrain_params/videomae_pretrain_vit_large_k400.pth"
        #     args.qkv_bias = False
        #     args.qkv_divided_bias = True
        #     args.qkv_divided = False
        ...
        if "base" in args.model and args.pretrained_method == 'videomae':
            ...
            args.qkv_divided = False
        # elif "large" in args.model and args.pretrained_method == 'videomae':
        #     pretrained_path = "/home/syangcw/SurgSSL/pretrain_params/videomae_pretrain_vit_large_hybrid.pth"
        #     args.qkv_bias = False
        ...
        if "base" in args.model and args.pretrained_method == 'supervised':
            ...
            args.qkv_divided_bias = False
            args.qkv_divided = False
        # elif "large" in args.model and args.pretrained_method == 'mae':
        #     pretrained_path = "/home/syangcw/SurgSSL/pretrain_params/mae_pretrain_vit_large.pth"
        #     args.qkv_bias = False
        #     args.qkv_divided_bias = False
        #     args.qkv_divided = False

    elif args.pretrained_data == "imagenet21k":
        if "base" in args.model and args.pretrained_method == 'supervised':
            pretrained_path = "/home/syangcw/SurgSSL/pretrain_params/supervised_base_imagenet21k.bin"
            args.qkv_bias = True
            args.qkv_divided_bias = False
            args.qkv_divided = False
        ...
        if "base" in args.model and args.pretrained_method == 'videomae-st':
            pretrained_path = "/project/mmendoscope/SurgSSL_output/[401]-[0.85]-[SurgeryMAEKD]-[pretrain_masked_video_student_base_patch16_224]-[surgery_teacher_vit_large_patch16]-[Cholec80_M2CAI16-tool_M2CAI16-workflow_HeiChole_PitVis_PSI-AVA_AutoLaparo_BernBypass70_StrasBypass70_GenSurgery]/checkpoint-199.pth"
            args.qkv_bias = False
            args.qkv_divided_bias = True
            args.qkv_divided = False
    else:
    ...
    model = create_model(
        ...
        qkv_divided_bias=args.qkv_divided_bias,
