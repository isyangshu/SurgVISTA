...
# param3_list=("unified_base_2D" "unified_base_2D" "unified_base_2D" "unified_base_2D")
...
for i in "${!param1_list[@]}"; do
    ...
    --layer_decay 0.75 \
    --warmup_epochs 5 \
    --data_path /scratch/mmendoscope/downstream/CATARACT \
    --eval_data_path /scratch/mmendoscope/downstream/CATARACT \
    --nb_classes 19 \
    ...
    --data_set CATARACT \
    --data_fps 1fps \
    --output_dir /project/mmendoscope/Natural_Comparison/CATARACT \
    --log_dir /project/mmendoscope/Natural_Comparison/CATARACT \
    --num_workers 16 \
    --dist_eval \
    --enable_deepspeed \
    --no_auto_resume
