...
for i in "${!param1_list[@]}"; do
    ...
    --layer_decay 0.75 \
    --warmup_epochs 5 \
    --data_path /project/medimgfmod/syangcw/downstream/M2CAI16 \
    --eval_data_path /project/medimgfmod/syangcw/downstream//M2CAI16 \
    --nb_classes 8 \
    ...
    --data_set M2CAI16 \
    --data_fps 1fps \
    --output_dir /project/mmendoscope/SurgSSL/KD/M2CAI16 \
    --log_dir /project/mmendoscope/SurgSSL/KD/M2CAI16 \
    --num_workers 16 \
    --dist_eval \
    --enable_deepspeed \
    --no_auto_resume
