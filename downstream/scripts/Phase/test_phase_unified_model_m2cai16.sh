...
for i in "${!param1_list[@]}"; do
    ...
    --eval \
    --finetune /project/mmendoscope/Natural_Comparison/M2CAI16/unified_base_st_settingD_videomae-st_M2CAI16_0.0001_0.75_online_key_frame_frame16_Fixed_Stride_4/checkpoint-best/mp_rank_00_model_states.pt \
    --num_frames 16 \
    --sampling_rate 4 \
    --data_set M2CAI16 \
    --data_fps 1fps \
    --output_dir /project/mmendoscope/Natural_Comparison/M2CAI16 \
    --log_dir /project/mmendoscope/Natural_Comparison/M2CAI16 \
    --num_workers 4 \
    --dist_eval \
    --enable_deepspeed \
    --no_auto_resume
