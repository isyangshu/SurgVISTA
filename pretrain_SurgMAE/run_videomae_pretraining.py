...
from datasets.datasets4pretraining.datasets_pretraining import build_pretraining_dataset
from pretrain_SurgMAE.engine_for_videomae_pretraining import train_one_epoch
from utils import NativeScalerWithGradNormCount as NativeScaler
import utils
import pretrain_SurgMAE.modeling_videomae as modeling_videomae


def get_args():
    parser = argparse.ArgumentParser("Surgical VideoMAE pre-training script", add_help=False)
...
def main(args):
    ...
    args.output_dir = os.path.join(
        args.output_dir,
        "[SurgeryMae]-[{model}]-[{dataset}]-[{maskratio}]-[{epochs}]".format(
                model=args.model,
