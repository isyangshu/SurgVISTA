...
from pretrain_SurgMAE.utils_ import (
    Block,
    _cfg,
    PatchEmbed,
...
# TODO: unify the hyperparameters and code of the two versions of the SurgMAE/SurgMAEKD
# SurgMAE: No CLS Token & Fixed Position Embedding & 3D with tube 2
class PretrainVisionTransformerEncoder(nn.Module):
    ...
    def __init__(
        ...
        if use_learnable_pos_emb:
            ...
            # TODO: Differences between two types of position embeddings
            # sine-cosine positional embeddings for SurgMAE
            self.pos_embed = get_sinusoid_encoding_table(num_patches, embed_dim)
            # sine-cosine positional embeddings for SurgMAEKD
...
class PretrainVisionTransformer(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        B, N, C = x_vis.shape
        # we don't unshuffle the correct visible token order, but shuffle the pos embedding accorddingly.
        expand_pos_embed = (
